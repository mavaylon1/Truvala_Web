    ...
    <>
      ...
      <SmoothScroller>
        <main
          ...
          style={{ paddingTop: 60, paddingBottom: 40, paddingLeft: 24, paddingRight: 24 }}
        >
          <motion.div
          ...
          >
            ...
            <p style={{ fontSize: 18, color: '#6b7280', lineHeight: 1.65, maxWidth: 520 }}>
            ...
            {/* Date line */}
            <p style={{ fontSize: 14, color: '#9ca3af', letterSpacing: '0.06em', fontWeight: 500 }}>
